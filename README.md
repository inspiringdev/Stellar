...
## 📊 Visual Results
Below are the outputs generated by running the experiments. These demonstrate the convergence speed and scalability of the STELLAR algorithm.

**Figure 2: Convergence Comparison**
STELLAR (LLM) vs Vanilla PPO vs Random — sum rate vs iterations/episodes.
![Convergence Plot](experiments/results/fig2_convergence.png)
...
![RSMA vs SDMA](experiments/results/fig4_rsma_vs_sdma.png)

**Figure 5: Population Convergence**
Best vs Worst individual achievable rate over generations.
![Population Convergence](experiments/results/fig5_population_convergence.png)
